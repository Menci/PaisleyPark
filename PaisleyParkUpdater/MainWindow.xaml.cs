...
namespace PaisleyParkUpdater
{
	...
	public partial class MainWindow : Window
	{
		...
		public MainWindow()
		{
			...
			if (WebRequest.Create("https://api.github.com/repos/Menci/PaisleyPark/releases/latest") is HttpWebRequest request)
			{
				request.Method = "GET";
				...
				catch (Exception)
				{
					...
					if (response == MessageBoxResult.Yes)
					{
						...
						Process.Start("https://github.com/Menci/PaisleyPark/releases/latest");
					}
				}
			}
		}
